...
def run_algo(ticker, starting_capital, starting_shares, start_date="2017-01-01", end_date="2020-12-24"):
    ...
    price_history = ticker_info.history(start=start_date,  end=end_date)
...
while True:
    ...
    if ticker == 'exit':
        ...
        for ticker in watchlist:
            portfolio, entry_price, control_value, algo_value, prices, days = run_algo(ticker, starting_capital, starting_shares,start_date="2018-01-01", end_date=date.today())
